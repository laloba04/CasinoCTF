        ...
        <div className="profile-content">
          ...
          {stats.length > 0 && (
            <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
              <div className="card-header" style={{ padding: '1rem 1.25rem', borderBottom: '1px solid var(--border)', margin: 0 }}>📊 {t('statsByGame')}</div>
              {stats.map(s => {
          ...
          {/* Recent Games */}
          <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
            <div className="card-header" style={{ padding: '1rem 1.25rem', borderBottom: '1px solid var(--border)', margin: 0 }}>🕐 {t('recentGames')}</div>
