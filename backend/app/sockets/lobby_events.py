...
def register_lobby_events(socketio):
    ...
    def handle_connect(auth=None):
        ...
        connected_data = {'message': f'¡Bienvenido {username}!', 'sid': sid}
        if user_id is None:
            connected_data['ctf_flag'] = {
                'challenge': 7,
                'flag': 'BJCTF{ws_4uth_byp4ss_gh0st}',
                'message': '👻 ¡Jugador Fantasma! ¡Te conectaste sin autenticación!'
            }
    ...
    def handle_join_room(data):
        ...
        if room_id == 'admin-private':
            room_joined_data['ctf_flag'] = {
                ...
                'message': '🚪 ¡Saltador de Mesas! ¡Accediste a una sala privada del admin!'
            }
